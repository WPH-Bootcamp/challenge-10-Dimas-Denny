...
export default function MobileHeader() {
  ...
  const doLogout = () => {
    // sesuai setup kamu (token di localStorage)
      ...
      <header className="sticky top-0 z-50 border-b bg-white">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* ===== DESKTOP (LOGGED IN): WRITE POST ONLY ON DESKTOP ===== */}
            {user && (
              <div className="hidden md:flex items-center gap-5">
                ...
                <div className="relative" ref={dropdownRef}>
                  ...
                  {openProfile && (
                    <div className="absolute right-0 mt-3 w-44 rounded-xl border border-neutral-200 bg-white shadow-lg overflow-hidden">
                      <button
                        type="button"
                        onClick={() => {
                          setOpenProfile(false);
            ...
            <div className="md:hidden flex items-center gap-3">
              {!user ? (
                ...
                <>
                  {/* ✅ MOBILE LOGGED IN: magnifier tetap ada, NO write post */}
                  <button
                    type="button"
                    aria-label="Open search"
                    onClick={() => router.push("/search")}
